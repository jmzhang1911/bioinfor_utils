...
foreach (@files){
	...
	`cp $_ $output/Web_Report/QC_Report/ || echo skipping` unless (-e "$output/Web_Report/QC_Report/$_");
}
##########################
...
if(-f "$output/Web_Report/QC_Report/b_total_vdj_info_stat.xls") {
...
if(-f "$output/Web_Report/QC_Report/t_total_vdj_info_stat.xls") {
...
if(-f "$output/Web_Report/QC_Report/b_total_cell_info_stat.xls") {
...
if(-f "$output/Web_Report/QC_Report/t_total_cell_info_stat.xls"){
